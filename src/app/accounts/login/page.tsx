...
const Login = () => {
  return (
    <div className='flex h-[100vh] w-full bg-white'>
      <Image src={loginBackground} alt='Flight' className='w-[60%] object-cover' />
      <div className='w-[40%] flex items-center justify-center p-20'>
        <div className='flex flex-col gap-8'>
          ...
          <span className='flex flex-col gap-1'>
            ...
            <p className='font-nunito text-lg'>Welcome back. Enter your credentials to access your account</p>
          </span>
          <LoginForm />
          <LoginOtherOptions />
          <SignupRedirect />
