...
import { TCategoryTree } from "@/components/SideBar/types/TCategoryTree";
import TertiaryButton from "@/components/Buttons/TertiaryButton";
import IconRenderer from "@/components/IconRenderer/page";
import { buildCategoryTree } from "@/components/SideBar/utils/buildCategoryTree";
...
export default function CascadeSelect({
  ...
  const [selectedName, setSelectedName] = useState<string>(
    rawCategory.filter((category) => category.id === value)[0]?.name
  );
